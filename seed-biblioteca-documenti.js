...
const documentiData = [
  {
    ...
    author: 'Avventisti del Settimo Giorno Movimento di Riforma',
  ...
  {
    title: 'Lezionario Biblico - Secondo Trimestre 2026',
    author: 'Avventisti del Settimo Giorno Movimento di Riforma',
    description: 'Studio biblico trimestrale per il secondo trimestre 2026. Nuovi approfondimenti per l\'anno nuovo.',
    category: 'lezionario',
    subcategories: ['studio-biblico', 'devozione'],
    tags: ['lezionario', 'bibbia', 'studio', '2026', 'q2', 'trimestre'],
    filePath: '/documents/Lezionario-2-2026.pdf',
    fileUrl: 'http://localhost:5000/documents/Lezionario-2-2026.pdf',
    cover: 'https://via.placeholder.com/300x400/667eea/ffffff?text=Lezionario+Q2+2026',
    language: 'it',
    publisher: 'Edizioni sdarm',
